...
export const Navbar = () => {
  ...
  return (
    <header className="z-[999] relative">
      <motion.div
        className="bg-gray-950 border-black/40 bg-opacity-75 fixed top-0 left-1/2 h-[4.5rem] w-full rounded-none border  border-opacity-40 shadow-lg shadow-black/[0.03] backdrop-blur-[0.5rem] sm:top-6 sm:h-[3.25rem] sm:w-[36rem] sm:rounded-full"
